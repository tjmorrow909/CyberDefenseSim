...
class MockStorage implements IStorage {
  ...
  async getAllDomains() { return []; }
  async getDomain(id: number) { return undefined; }
  async getScenario(id: number) { return this.scenarios.get(id); }
  async storeRefreshToken(userId: string, token: string) {}
  async getRefreshToken(token: string) { return undefined; }
